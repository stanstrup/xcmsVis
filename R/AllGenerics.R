...
#' settings, especially the `bw` (bandwidth) parameter which controls the
#' smoothing of the density estimate.
#'
#' **Note:** Currently only supports plotting a single row (m/z slice) across
#' multiple samples. If `object` has multiple rows, please subset to one row
#' first.
#'
#' @author Jan Stanstrup
#'
...
#'
#' @export
setGeneric("gplotChromPeakDensity",
           function(object,
                    param,
                    col = "#00000060",
...
#'
#' @export
setGeneric("gplotChromatogramsOverlay",
           function(object,
                    col = "#00000060",
                    type = "l",
                    main = NULL,
...
#' customized using *ggplot2*'s `labs()` function, e.g.,
