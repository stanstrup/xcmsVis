...
# Note: ghighlightChromPeaks works on the chromatogram object which already
# contains only the peaks for this specific chromatogram (one file, one m/z range)
...
peaks_any <- ghighlightChromPeaks(
  chr[1, 1], rt = rt_range, mz = mz_range,
