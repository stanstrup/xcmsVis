...
By default, `gplotChromPeakImage()` uses the viridis color scale, which is perceptually uniform and colorblind-friendly. You can customize the color palette to suit your needs:
