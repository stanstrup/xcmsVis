...
# Use SerialParam for faster processing with small datasets
xdata_grouped <- groupChromPeaks(xdata_peaks, param = pdp, BPPARAM = SerialParam())
```
...
xdata_filtered <- groupChromPeaks(xdata_filtered, param = pdp_filtered, BPPARAM = SerialParam())
