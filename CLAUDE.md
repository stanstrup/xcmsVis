...
2.  **ALWAYS reuse XCMS internal functions when possible**:
    ...
    - **DO**: Call XCMS internal functions directly using
      `xcms:::functionName()`
    - **DO**: Reuse XCMS’s data processing, mathematical, and
    ...
    - Examples of what to reimplement:
      - Base R plotting calls
        ...
        [`rect()`](https://rdrr.io/r/graphics/rect.html)) → replace with
        ggplot2
...
4.  **Pay special attention to**:
    ...
    - **Parameter meanings**: Always read the XCMS documentation
      ...
      - XCMS documentation is authoritative - don’t guess parameter
        behavior
...
- **XCMS Utils Maintenance**: `dev-docs/XCMS_UTILS_MAINTENANCE.md` -
  Guide for maintaining copied XCMS functions
...
function doesn’t need to know about object types.
